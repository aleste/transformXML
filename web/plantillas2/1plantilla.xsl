    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
      ...
      <fo:layout-master-set>
        ...
        <fo:simple-page-master master-name="landscape" page-height="21cm" page-width="29.7cm"  margin-top="1cm"  margin-bottom="2cm"  margin-left="1.5cm"  margin-right="1.5cm" >
          ...
          <fo:region-body
            background-image="url('img/overlay_small.gif')"
        ...
        <fo:simple-page-master master-name="portrait"  page-height="29.7"  page-width="21"  margin-top="1cm"  margin-bottom="2cm"  margin-left="1.5cm"  margin-right="1.5cm"  >
          <fo:region-body
            ...
            background-position="center"
            background-repeat="no-repeat"
            margin-top="0.5cm" margin-bottom="1.5cm"  margin-left="0.5cm" margin-right="0.5cm"/>
          <fo:region-before precedence="true" extent="3cm"/>
          <fo:region-after precedence="true" extent="1.5cm"/>
          <fo:region-start extent="1cm"/>
          <fo:region-end extent="1cm"/>
 ...
 <xsl:template match="planes_caducos" name="planes_int">
    ...
    <fo:page-sequence master-reference="portrait">
      ...
      <fo:static-content flow-name="xsl-region-before">
        ...
        <fo:flow font-family="monospace" flow-name="planes-flow">
          <fo:table width="18cm">
            <fo:table-column />
            <fo:table-column />
            <fo:table-column />
            ...
            <fo:table-body>
              ...
              <fo:table-row font-size="11pt" text-align="center">
                <fo:table-cell number-columns-spanned="2" number-rows-spanned="2">
                  <fo:block>
                     <fo:external-graphic scaling="uniform" content-type="image/gif" src="url('img/arba.gif')"/>
                  </fo:block>
                </fo:table-cell>
                ...
                <fo:table-cell  border="0.6pt solid black"  number-columns-spanned="1">
	...
	<xsl:template name="datos-titulo">
	    ...
	    <fo:table-cell number-columns-spanned="2" number-rows-spanned="2">
	      <fo:block>
	         ...
	         <fo:external-graphic content-width="scale-to-fit" content-height="100%" width="100%" scaling="uniform" content-type="image/gif" src="url('img/arba.gif')"/>
	      </fo:block>
	    </fo:table-cell>
